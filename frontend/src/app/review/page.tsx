...
export default function ReviewPage() {
  ...
  if (!data) return <div className="p-4 md:p-6 text-center text-slate-600">Loading Case Review...</div>;
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-6 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-4 md:mt-6 w-full">
      <div className="md:col-span-2 bg-white p-4 md:p-6 rounded-xl shadow-md border border-slate-200 w-full">
        <h3 className="text-lg md:text-xl font-bold text-slate-800 mb-4 border-b pb-2">Doctor Review Gate (Editable)</h3>

        {data.missing_information?.is_missing && (
          <div className="bg-amber-50 border-l-4 border-amber-500 p-3 md:p-4 mb-5 rounded-r">
        ...
        <div className="mt-6 flex justify-end">
          <button
            ...
            disabled={saving}
            className="w-full md:w-auto bg-emerald-600 text-white text-sm md:text-base font-semibold px-6 py-2.5 rounded-lg hover:bg-emerald-700 transition disabled:opacity-50"
          >
      ...
      <div className="bg-slate-50 p-4 md:p-6 rounded-xl border border-slate-200 h-fit space-y-4 w-full">
        <h3 className="text-base md:text-lg font-bold text-slate-800 border-b pb-2">Clinical Decision Support</h3>
